function    [p,theta,...                            % Sytem outputs
            ...
            Sigi_SISO_LQR_Fullstate_stabilisiert_NonlinearODE(...
            p_ref, theta_ref,...                           % Sytem input
            p,p_dot,theta,theta_dot,...             % System states
            l, r, g,...
            K_lqr_1, K_lqr_2, K_lqr_3, K_lqr_4)                                % System parameters
...
%     phiw_dot_ref = -K_lqr*[p_dot,theta,theta_dot]' + theta_ref * K_lqr(2);
    phiw_dot_ref = -K_lqr*[p,p_dot,theta,theta_dot]' + p_ref * K_lqr(1) + theta_ref * K_lqr(3) ;
